...
int main()
{
  ...
  */
  ...
  if ((trials = diffiepolrho(165000000, &dhprime,&dhgen, &pkeyA, &skeyAguess)) == 0)
    {
    printf("failure to find it.... \n");
    }
  else
    {
    printf("we found a candidate for Alice's secret key !  We needed %d trials. It is : \n",trials);
    printnum(&skeyAguess);
  ...
  if ((trials = diffiepolrho(165000000, &dhprime,&dhgen, &pkeyB, &skeyBguess)) == 0)
    {
    printf("failure to find it.... \n");
    }
  else
    {
    printf("we found a candidate for Bob's secret key !  We needed %d trials. It is : \n",trials);
    printnum(&skeyBguess);
